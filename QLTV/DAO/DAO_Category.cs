...
namespace DAO
{
    public class DAO_Category:Connection
    {
        ...
        {
            string sql = "INSERT INTO Category(category_id, category_name) VALUES('" + category.Category_id + "',N'" + category.Category_name + "');";
        ...
        {
            String sql = "DELETE Category WHERE category_id = " + category_id + ";";
            return this.ExecuteNonQuery(sql);
        }

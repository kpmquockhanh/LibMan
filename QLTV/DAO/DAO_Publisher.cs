...
namespace DAO
{
    public class DAO_Publisher:Connection
    {
        ...
        {
            string sql = "UPDATE Publisher SET publisher_name = N'" + publisher.Publisher_name + "', publisher_address = '"
        ...
        {
            String sql = "DELETE Publisher WHERE publisher_id = '" + publisher_id + "'";
            return this.ExecuteNonQuery(sql);
        }
